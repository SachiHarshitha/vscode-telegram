...
export const TELEGRAM_REMOTE_PATCH_REVISION = 3;
 ...
 * an ordinary workspace. The Phase 2 transport contribution is dormant until Phase 3 supplies
 * consented secret storage and an authorized update handler.
 */
