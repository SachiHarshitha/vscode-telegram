...
try {
	...
	$testFiles = @(
		'src/extension/telegramRemote/common/test/pendingRequestContext.spec.ts',
		'src/extension/telegramRemote/common/test/telegramRemoteCompatibility.spec.ts',
		'src/extension/telegramRemote/common/test/remoteAgentEvent.spec.ts',
		...
		'src/extension/telegramRemote/node/test/telegramSessionState.spec.ts',
		'src/extension/telegramRemote/node/test/telegramCommandRouter.spec.ts',
		'src/extension/telegramRemote/node/test/telegramEventRenderer.spec.ts',
		'src/extension/telegramRemote/node/test/telegramMarkdown.spec.ts',
		'src/extension/telegramRemote/node/test/telegramActivityCoalescer.spec.ts',
		'src/extension/telegramRemote/vscode-node/test/telegramSessionScope.spec.ts',
		'src/extension/telegramRemote/vscode-node/test/remotePromptDispatcher.spec.ts',
		'src/extension/telegramRemote/vscode-node/test/missionControlTransport.spec.ts',
		'src/extension/telegramRemote/vscode-node/test/telegramRemoteContribution.spec.ts',
		'src/extension/telegramRemote/vscode-node/test/telegramSetupWizard.spec.ts',
	...
	Assert-LastExitCode 'Phase 5.1 Vitest suite'
} finally {
	Pop-Location
}
